...
def face_encodings(face_image, known_face_locations=None, num_jitters=1):
    ...
    # print("raw landmarks: {}".format(landmarks_as_tuples))
    # print("length of raw landmarks: {}".format(len(landmarks_as_tuples[0])))
    raw = [raw_land for raw_land in raw_landmarks]
