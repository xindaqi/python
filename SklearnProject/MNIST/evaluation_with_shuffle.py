...
def sub_roc(fpr, tpr, label=None):
    plt.figure(figsize=(12, 3))
    plt.subplots_adjust(wspace=0.4)
    plt.subplot(1, 3, 1).set_title("ROC=1")
    plt.plot([0,0], [0, 1], "r-")
    plt.plot([0,1], [1,1], "r-")
    ...
    plt.ylabel("真正类率", fontproperties=font)
    plt.grid("True")
    plt.subplot(1, 3, 2).set_title("ROC=(0.5,1)")
    plt.subplots_adjust(wspace=0.4)
    plt.plot(fpr, tpr, "r-")
    plt.axis([-0.1, 1, 0, 1.1])
    plt.grid("True")
    plt.xlabel("假正类率", fontproperties=font)
    plt.ylabel("真正类率", fontproperties=font)
    plt.subplot(1, 3, 3).set_title("ROC=0.5")
    plt.subplots_adjust(wspace=0.4)
    plt.plot([0, 1], [0, 1], "r-")
    plt.axis([-0.1, 1, 0, 1.1])
    plt.grid("True")
...
def sub_auc(fpr, tpr, label=None):
    plt.figure(figsize=(12, 3))
    plt.subplots_adjust(wspace=0.4)
    plt.subplot(1, 3, 1).set_title("AUC=1")
    plt.plot([0, 1], [0, 1], "k--")
    plt.plot([0,0], [0, 1], "r-")
    plt.plot([0,1], [1,1], "r-")
    plt.axis([-0.1, 1, 0, 1.1])
    ...
    plt.ylabel("真正类率", fontproperties=font)
    plt.grid("True")
    plt.subplot(1, 3, 2).set_title("AUC=(0.5,1)")
    plt.subplots_adjust(wspace=0.4)
    plt.plot([0, 1], [0, 1], "k--")
    plt.plot(fpr, tpr, "r-")
    plt.axis([-0.1, 1, 0, 1.1])
    ...
    plt.xlabel("假正类率", fontproperties=font)
    plt.ylabel("真正类率", fontproperties=font)
    plt.subplot(1, 3, 3).set_title("AUC=0.5")
    plt.subplots_adjust(wspace=0.4)
    plt.plot([0, 1], [0, 1], "k--")
    plt.plot([0, 1], [0, 1], "r-")
    plt.axis([-0.1, 1, 0, 1.1])
    ...
    plt.xlabel("假正类率", fontproperties=font)
    plt.ylabel("真正类率", fontproperties=font)
    plt.savefig("./images/sub_auc.png", format="png")
    plt.show()
sub_auc(fpr, tpr)